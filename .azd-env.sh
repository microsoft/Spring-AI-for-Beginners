...
AZURE_OPENAI_DEPLOYMENT="${AZD_DEPLOYMENT:-${AZURE_OPENAI_DEPLOYMENT:-gpt-5.6-luna}}"
AZURE_OPENAI_FAST_DEPLOYMENT="${AZD_FAST_DEPLOYMENT:-${AZURE_OPENAI_FAST_DEPLOYMENT:-gpt-5.6-luna}}"
